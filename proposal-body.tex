...
\begin{figure}[!tbp]
    \centering
    \subfloat[Noisy]{\includegraphics[width=0.4\textwidth]{figures/noisy_audio.jpg}\label{fig:noisy_audio}}
    \hfill
    \subfloat[Clean]{\includegraphics[width=0.4\textwidth]{figures/clean_audio.jpg}\label{fig:clean_audio}}
